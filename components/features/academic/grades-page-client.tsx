...
import { Award, FileSpreadsheet, ListOrdered, Loader2 } from "lucide-react";

// Code-splitting de la planilla matricial para máxima velocidad de carga inicial
const DynamicGradeMatrixSpreadsheet = dynamic(
  () =>
    import("@/components/features/academic/grade-matrix-spreadsheet").then(
    ...
    loading: () => (
      <div className="p-12 rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-center flex flex-col items-center justify-center gap-3">
        ...
        <span className="text-xs font-bold text-slate-700 dark:text-slate-300">
          Cargando Planilla Matricial de Alta Densidad...
        </span>
      </div>
    ),
  }
