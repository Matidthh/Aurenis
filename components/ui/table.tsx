...
export function TablePagination({
  ...
  return (
    <div
      className={cn(
        "flex flex-col sm:flex-row items-center justify-between px-4 py-3 border-t border-slate-200 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-850/50 text-xs text-slate-500 dark:text-400 gap-3",
        className
      )}
    >
      <div className="flex items-center gap-4">
        ...
        {pageSizeOptions && onItemsPerPageChange && (
          <select
            ...
            className="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-md py-1 px-2 text-xs"
          >
