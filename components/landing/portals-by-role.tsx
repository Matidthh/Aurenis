...
export function PortalsByRole() {
  ...
  const rolesContent = {
    ...
    docente: {
      ...
      features: [
        ...
        "Control de leccionario digital acreditado con objetivos de aprendizaje (OA) Mineduc.",
        "Ficha 360° del estudiante con historial socioemocional, notas y adecuaciones PIE.",
        "Firma electrónica de actas y sincronización automática sin doble digitación.",
      ],
      previewStats: [
  ...
  return (
    <section className="relative w-full pt-16 pb-24 bg-[#F8F8F5] overflow-hidden">
      <div className="max-w-[1400px] mx-auto px-6 sm:px-10 lg:px-14 relative z-10">
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-14">
          ...
          <h2 className="text-3xl sm:text-5xl font-black text-slate-900 tracking-tight">
            Un Ecosistema Adaptado a Cada Rol Institucional
          </h2>
          <p className="text-base sm:text-lg text-slate-500 font-medium">
            Alumnos, profesores, directores de liceo y apoderados acceden a interfaces optimizadas para sus responsabilidades diarias, garantizando privacidad, rapidez y sincronización absoluta.
          </p>
        </div>
      ...
      <div className="flex items-center justify-center gap-2 flex-wrap mb-10">
        <button
          ...
          className={`flex items-center gap-2 px-5 py-3 rounded-2xl text-xs sm:text-sm font-bold transition-all ${
            activeTab === "estudiante"
              ? "bg-emerald-600 text-white shadow-lg shadow-emerald-500/25 scale-102"
        ...
        <button
          ...
          className={`flex items-center gap-2 px-5 py-3 rounded-2xl text-xs sm:text-sm font-bold transition-all ${
            activeTab === "apoderado"
              ? "bg-purple-600 text-white shadow-lg shadow-purple-500/25 scale-102"
              : "bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200"
          }`}
        >
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 p-6 sm:p-10 lg:p-12 shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="pt-4 flex items-center gap-4 flex-wrap">
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-2xl font-bold text-xs sm:text-sm bg-slate-900 hover:bg-blue-600 text-white transition shadow-md group"
            >
            ...
            <Link
              ...
              className="inline-flex items-center gap-1.5 px-4 py-3 rounded-2xl font-bold text-xs text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 transition"
            >
        ...
        <div className="lg:col-span-5 bg-slate-50 dark:bg-slate-850 rounded-2xl border border-slate-200 dark:border-slate-700 p-6 space-y-6 shadow-inner">
          <div className="flex items-center justify-between pb-3 border-b border-slate-200 dark:border-slate-750">
            ...
            <span className="inline-flex items-center gap-1 text-[11px] font-bold text-emerald-600 bg-emerald-50 dark:bg-emerald-950/60 px-2 py-0.5 rounded-md">
          ...
          <div className="p-4 rounded-xl bg-blue-50/80 dark:bg-blue-950/40 border border-blue-200/60 dark:border-blue-900/40 text-xs text-blue-800 dark:text-blue-300 space-y-1">
