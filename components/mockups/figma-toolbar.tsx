      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3 flex-wrap">
          ...
          <div className="flex items-center bg-slate-800/90 p-1 rounded-xl border border-slate-700/70 overflow-x-auto max-w-full">
            ...
            <button
              onClick={() => onTabChange("rbac-enforcement")}
              className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-semibold whitespace-nowrap transition-all ${
                activeTab === "rbac-enforcement"
                  ? "bg-gradient-to-r from-purple-600 via-indigo-600 to-rose-600 text-white shadow-xs ring-1 ring-white/20"
                  : "text-rose-300 hover:text-white hover:bg-rose-950/50"
              }`}
            >
              <ShieldAlert className="w-3.5 h-3.5 text-rose-300" />
              <span>RBAC & Gating de UI</span>
              <span className="text-[10px] px-1.5 py-0.2 rounded bg-rose-500/30 text-rose-200 font-bold">
                Seguridad 100%
              </span>
            </button>
            ...
            <button
              onClick={() => onTabChange("student-postgres")}
              className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-semibold whitespace-nowrap transition-all ${
                activeTab === "student-postgres"
                  ? "bg-gradient-to-r from-indigo-600 to-emerald-600 text-white shadow-xs ring-1 ring-white/20"
                  : "text-indigo-300 hover:text-white hover:bg-indigo-950/50"
              }`}
            >
              <Database className="w-3.5 h-3.5 text-indigo-300" />
              <span>Estudiantes en PostgreSQL</span>
              <span className="text-[10px] px-1.5 py-0.2 rounded bg-indigo-500/30 text-indigo-200 font-bold">
                DB Real
              </span>
            </button>
            ...
            <button
              onClick={() => onTabChange("teacher-postgres")}
              className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-semibold whitespace-nowrap transition-all ${
